...
Use this planner when a project is agreed but there are still important questions to answer. It helps to prevent you jumping straight to solutions or when you need to learn more before deciding how the work should move forward.


{{< questions
  heading="Uncover answers to:"
  q1="What do we need to understand before making decisions?"
  q2="What do we already know?"
  q3="Are we relying on assumptions?"
  q4="What uncertainty needs resolving?"
  >}}
