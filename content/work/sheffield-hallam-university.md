...
# Content
heading: A sustainable design system to underpin all digital projects
...
impact:
  text: SHU now has a shared visual language that any designer or developer can pick up and work with immediately, reducing design and development overhead across every new project and giving the university a platform that can grow consistently over time.
  img: images/work-shu-jackson.jpg
  img_alt: A young boy with a VR headset
...
{{< challenge >}}SHU had no consistent visual language across their digital properties, making it harder to maintain quality and consistency as their estate grew.
{{</ challenge >}}
